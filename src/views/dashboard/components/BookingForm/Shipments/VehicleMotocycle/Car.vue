      ...
      getTextFields () {
        return [
          ...
          },
          {
            ...
            name: 'manufacturer',
            type: 'select',
            options: ['Alfa Romeo','Aston Martin','Audi','BMW','Bentley','Bugatti','Buick','Cadillac','Caterham','Chevrolet','Chrysler','Citroen','Dodge','Ferrari','Fiat','Ford','GMC','Geely','Genesis','Honda','Hyundai','Infiniti','Jaguar','Jeep','Kia','Koenigsegg','Lamborghini','Lancia','Land Rover','Lexus','Lincoln','Lotus','Maserati','Maybach','Mazda','Mclaren','Mercedes Benz','Mini','Mitsubishi','Nissan','Opel','Pagani','Peugeot','Pontiac','Porsche','Ram','Renault','Rolls Royce','Smart','Subaru','Tesla','Toyota','Volkswagen','Volvo'],
          },
          {
